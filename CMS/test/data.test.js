...
describe("Data", function () {
  beforeEach(function (done) {
    ...
    let data = new Data({ letter: "test", frequency: 1.2 });
  ...
  afterEach(function (done) {
    User.findOneAndRemove({ email: "test@rmail.com" }).then(function () {
      Data.findOneAndRemove({ letter: "test" }).then(function () {
        done();
      });
    });
  });

  it("should get list from data with method POST", function (done) {
    chai
      .request(app)
      ...
      .end(function (err, response) {
        chai
          ...
          .send({ letter: "test", frequency: 1.2 })
          .end(function (err, res) {
            ...
            res.body[0].letter.should.equal("test");
      ...
      .end(function (err, response) {
        chai
          ...
          .end(function (err, res) {
            ...
            res.body.data.letter.should.equal("D");
  ...
  it("should find one data with method GET<ID_DATA>", function (done) {
    chai
      .request(app)
      .post("/api/users/login")
      .send({ email: "test@rmail.com", password: "1234" })
          ...
          .end(function (err, response) {
            chai
              ...
              .end(function (err, res) {
                ...
                res.body.data._id.should.be.a("string");
                res.body.data.letter.should.equal("test");
        ...
        chai
          ...
          .end(function (err, response) {
            chai
              .request(app)
              .delete(
                `/api/data/${response.body[response.body.length - 1]._id}`
              )
              .set("authorization", responseUser.body.token)
              .end(function (err, res) {
                res.body.should.be.a("object");
        ...
        chai
          ...
          .end(function (err, response) {
            chai
              ...
              .set("authorization", responseUser.body.token)
              .send({ letter: "testEdit", frequency: 1.5 })
              .end(function (err, res) {
                res.body.should.be.a("object");
                res.body.should.have.property("success");
                res.body.should.have.property("message");
                ...
                res.body.data._id.should.be.a("string");
                res.body.data.letter.should.equal("testEdit");
                res.body.data.frequency.should.equal(1.5);
